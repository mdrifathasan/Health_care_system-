...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edEmail = findViewById(R.id.editTextTextAppAddress);
        edPassword = findViewById(R.id.editTextTextAppContactNumber);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                com.example.healtcare_system.Database db = new com.example.healtcare_system.Database(getApplicationContext(),"Healthcare",null,1);
